...
public class RenderBomb extends Render<EntityBomb> {
    ...
    public RenderBomb(RenderManager rm) {
    	super(rm);
    ...
    @Override
    public void doRender(EntityBomb par1Entity, double par2, double par4, double par6, float par8, float par9) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityBomb par1Entity) {
